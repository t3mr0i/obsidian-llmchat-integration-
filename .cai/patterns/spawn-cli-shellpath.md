---
name: spawn-cli-shellpath
description: Spawn a child process from inside the plugin without falling into the macOS GUI PATH trap. Required reading any time you add a new spawn / exec call.
triggers:
  - "spawn"
  - "child_process"
  - "ENOENT"
