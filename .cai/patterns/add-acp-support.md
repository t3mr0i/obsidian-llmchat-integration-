---
name: add-acp-support
description: Wire a provider into the persistent ACP stdio executor (claude/gemini/codex pattern). Use after the provider already works via the CLI executor.
triggers:
  - "acp"
